      ...
      <div className={style.container}>
        ...
        <div className={style.skills}>
          ...
          <div className={style.skillsContainer}>
            ...
            <div>
             <img src="/images/react.svg" alt="react" /><span>React / 5 years</span>
            </div>
            <div>
              <img src="/images/gatsby.svg" alt="gatsby"/><span>Gatsby / 3 years</span>
            </div>
            <div>
              <img src="/images/next.svg" alt="next" /><span>Next.JS / 3 years</span>
            </div>
          </div>
        </div>
